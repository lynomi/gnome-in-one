...
- **Build** - Place blocks, clear blocks, adjust angle and power of the ball, preview simulation trajectory.
- **Swing** - Physics simulation runs. Player can reset to the build phase during the simulation.
- **Result** 
